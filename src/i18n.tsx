...
const es: Dict = {
  ...
  'text.imageHint': 'Sube un logo/imagen (PNG transparente ideal). Sustituye al texto de esta capa. No se incluye al compartir el enlace.',
...
const en: Dict = {
  ...
  'text.imageHint': 'Upload a logo/image (transparent PNG ideal). Replaces this layer’s text. Not included in share links.',
  'text.font': 'Font',
...
const pt: Dict = {
  ...
  'text.imageHint': 'Envie um logo/imagem (PNG transparente ideal). Substitui o texto desta camada. Não vai no link compartilhado.',
  'text.font': 'Fonte',
...
const ja: Dict = {
  ...
  'text.removeImage': '削除',
  'text.imageHint': 'ロゴ/画像をアップロード（透過PNG推奨）。このレイヤーのテキストの代わりになります。共有リンクには含まれません。',
  'text.font': 'フォント',
...
const ko: Dict = {
  ...
  'text.removeImage': '제거',
  'text.imageHint': '로고/이미지를 업로드하세요(투명 PNG 권장). 이 레이어의 텍스트를 대체합니다. 공유 링크에는 포함되지 않습니다.',
  'text.font': '글꼴',
